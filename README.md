...
The current hosted Studio deployment is [verity v0.1.1](https://thegraph.com/studio/subgraph/verity), deployment `QmQePELuMWViBC3wxwKxu1LdqNuDtJpzxeN2MvdW6pA1L9`, with query endpoint `https://api.studio.thegraph.com/query/1760236/verity/0.1.1`. It is a real hosted deployment over Base Sepolia, and its live `_meta` block has advanced past the Verity registrations. The provider Agent0 identity is `9221`, registered in [Base Sepolia transaction 0xca1fcd45](https://sepolia.basescan.org/tx/0xca1fcd45e24a3f68348d93e23323f27f69e80b3bbd9c9756caae1269d21c58b7); the buyer identity is `9222`, registered in [Base Sepolia transaction 0x1af6f8c0](https://sepolia.basescan.org/tx/0x1af6f8c0ea8b1191c40f8257e28ca3413f4a53aad94ac6e1c42bf24d4ef1d44b). The live query returns both Agent entities and their registration files. Agent0 feedback events still need to be written by the adjudication run before Verity reliability and honesty scores can be claimed. The endpoint is rate-limited Studio infrastructure, not a production Graph Network publication.
